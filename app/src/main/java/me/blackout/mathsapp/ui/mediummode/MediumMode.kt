...
import me.blackout.mathsapp.ui.easymode.EasyModeViewModel
import java.util.Random

class MediumMode : Fragment() {

    companion object {
        fun newInstance() = MediumMode()
    }

    private var _binding: FragmentMediumModeBinding? = null

    // This property is only valid between onCreateView and
    // onDestroyView.
    private val binding get() = _binding!!

    private lateinit var viewModel: MediumModeViewModel
    ...
    override fun onCreateView(
        ...
        val viewModel =
            ViewModelProvider(this).get(MediumModeViewModel::class.java)

        _binding = FragmentMediumModeBinding.inflate(inflater, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(MediumModeViewModel::class.java)
    }
